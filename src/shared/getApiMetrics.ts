import { StarryMessage } from "./ExtensionMessage"
...
/**
 * Calculates API metrics from an array of StarryMessages.
 *
 * This function processes 'api_req_started' messages that have been combined with their
 * corresponding 'api_req_finished' messages by the combineApiRequests function.
 * It extracts and sums up the tokensIn, tokensOut, cacheWrites, cacheReads, and cost from these messages.
 *
 * @param messages - An array of StarryMessage objects to process.
 ...
 */
export function getApiMetrics(messages: StarryMessage[]): ApiMetrics {
